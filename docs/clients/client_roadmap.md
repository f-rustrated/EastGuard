...
- **Idempotent produce** — the complete client/server protocol is designed in
  ...
  identities, independently ordered lanes, metadata-backed fencing, recovery journal, and bounded retry lifetime. Cross-range transactions and end-to-end exactly-once processing remain separate future work.
